    ...
    public partial class New_customer : Form
    {
        ...
        private void mailer(string report, string recirver)
        {
            try
            {
                ...
                SmtpServer.Credentials = new System.Net.NetworkCredential("arctic-seasport@hotmail.no", "eple1960");
